		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
            		...
            		{{WRAPPER}} .uael-gf-style button[type="submit"],
            		{{WRAPPER}} .uael-gf-style button[type="button"],
            		{{WRAPPER}} .uael-gf-style .gform_button,
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					{{WRAPPER}} .uael-gf-style button[type="submit"],
					{{WRAPPER}} .uael-gf-style button[type="button"],
					{{WRAPPER}} .uael-gf-style .gform_button' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .uael-gf-style input[type="submit"]:hover, {{WRAPPER}} .uael-gf-style input[type="button"]:hover, {{WRAPPER}} .uael-gf-style button[type="submit"]:hover, {{WRAPPER}} .uael-gf-style button[type="button"]:hover, {{WRAPPER}} .uael-gf-style .gform_button:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .uael-gf-style input[type="submit"]:hover, {{WRAPPER}} .uael-gf-style input[type="button"]:hover, {{WRAPPER}} .uael-gf-style button[type="submit"]:hover, {{WRAPPER}} .uael-gf-style button[type="button"]:hover, {{WRAPPER}} .uael-gf-style .gform_button:hover' => 'border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				{{WRAPPER}} .gform-theme.gform-theme--framework.gform_wrapper input[type="submit"].button.gform_button:where(:not(.gform-theme-no-framework):not(.gform-theme__disable):not(.gform-theme__disable *):not(.gform-theme__disable-framework):not(.gform-theme__disable-framework *)):hover,
 				...
 				{{WRAPPER}} .uael-gf-style button[type="submit"]:hover, {{WRAPPER}} .uael-gf-style button[type="button"]:hover,
 				{{WRAPPER}} .uael-gf-style .gform_button:hover',
			)
		);
	...
	protected function register_typography_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				{{WRAPPER}} .uael-gf-style button[type="submit"], {{WRAPPER}} .uael-gf-style button[type="button"],
				{{WRAPPER}} .uael-gf-style .gform_button,
