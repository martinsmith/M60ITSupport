...
abstract class Skin_Base extends Elementor_Skin_Base {
	...
	public function register_info_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'reviewer_image_source',
				array(
					'label'       => __( 'Reviewer Image Source', 'uael' ),
					'type'        => Controls_Manager::SELECT,
					'default'     => 'google',
					'options'     => array(
						'google' => __( 'Load from Google', 'uael' ),
						'local'  => __( 'Store locally (GDPR-friendly)', 'uael' ),
					),
					'description' => __( 'Store locally downloads Google reviewer images to your server so visitors\' browsers never connect to Google. Images are cached temporarily and refreshed with your reviews. On All-source widgets this covers Google avatars only; Yelp images continue to load from Yelp.', 'uael' ),
					'condition'   => array(
						$this->get_control_id( 'reviewer_image' ) => 'yes',
						'review_type' => array( 'google', 'all' ),
					),
					'render_type' => 'template',
				)
			);
