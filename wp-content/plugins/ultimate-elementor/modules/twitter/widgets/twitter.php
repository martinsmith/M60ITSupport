...
class Twitter extends Common_Widget {
	...
	protected function register_account_controls() {
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'X Handle', 'uael' ),
				'type'        => Controls_Manager::TEXT,
				'description' => esc_html__( 'Enter your X Handle WITHOUT @ sign.', 'uael' ),
				'condition'   => array(
		...
		$this->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::TEXT,
				'description' => esc_html__( 'Enter your X hashtag WITHOUT # sign.', 'uael' ),
				'condition'   => array(
		...
		if ( empty( self::$integration_settings['uael_twitter_feed_consumer_key'] ) || empty( self::$integration_settings['uael_twitter_feed_consumer_secret'] ) ) {
			...
			$this->add_control(
				...
				array(
					...
					'raw'             => sprintf( __( 'To display X Feed, you need to configure X Consumer keys. Please configure keys from <a href="%s" target="_blank" rel="noopener">here</a>.', 'uael' ), $admin_link ),
	...
	protected function register_content_tab() {
		...
		$this->add_control(
			...
			array(
				'label'        => esc_html__( 'X Handle', 'uael' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show ', 'uael' ),
				'label_off'    => __( 'Hide', 'uael' ),
				'default'      => 'yes',
					...
					if ( empty( $items ) && $is_editor ) {
						...
						<div class="uael-builder-msg elementor-alert elementor-alert-warning">
							<span class="elementor-alert-title">
								<?php esc_html_e( 'X Feed - ID ', 'uael' ); ?><?php echo esc_html( $page_id ); ?>
							</span>
							<span class="elementor-alert-description">
								<?php esc_html_e( 'To show X Feed widget, please set the valid Hashtag from widget settings.', 'uael' ); ?><br>
							</span>
						</div>
						<?php
						return;
				...
				if ( ! empty( $response['response'] ) && 200 === $response['response']['code'] ) {
					...
					if ( ! empty( $tweets_response['response'] ) && 200 === $tweets_response['response']['code'] ) {
						...
						<div class="uael-builder-msg elementor-alert elementor-alert-warning">
							...
							<span class="elementor-alert-description">
								<?php esc_html_e( 'To show X Feed widget, please set valid Consumer key and Consumer Secret Key.', 'uael' ); ?><br>
								<?php esc_html_e( 'Navigate to  WP Dashboard -> UAE -> Settings -> Integrations.', 'uael' ); ?>
							</span>
						</div>
						<?php
	...
	public function warning( $settings, $twitter_username ) {
		...
		if ( ( '' === $twitter_consumer_key || '' === $twitter_consumer_secret ) && $is_editor ) {
			...
			<div class="uael-builder-msg elementor-alert elementor-alert-warning">
				...
				<span class="elementor-alert-description"><?php esc_html_e( 'To show X Feed widget, please set the Consumer key and Consumer Secret Key.', 'uael' ); ?><br>
					<?php esc_html_e( 'Navigate to  WP Dashboard -> UAE -> Settings -> Integrations.', 'uael' ); ?>
				</span>
			</div>
			<?php
			...
			<div class="uael-builder-msg elementor-alert elementor-alert-warning">
				...
				<span class="elementor-alert-description">
					<?php
						/* translators: %s X name */
						echo esc_html( sprintf( __( 'To show X Feed widget, please set the %s from widget settings.', 'uael' ), $twitter_name ) );// phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText
					?>
					<br>
				</span>
			</div>
