...
class Browser extends Condition {
	...
	public function compare_value( $settings, $operator, $value ) {
		...
		$show       = false;
		$user_agent = isset( $_SERVER['HTTP_USER_AGENT'] ) ? UAEL_Helper::get_browser_name( sanitize_text_field( wp_unslash( $_SERVER['HTTP_USER_AGENT'] ) ) ) : ''; // phpcs:ignore WordPressVIPMinimum.Variables.RestrictedVariables.cache_constraints___SERVER__HTTP_USER_AGENT__
