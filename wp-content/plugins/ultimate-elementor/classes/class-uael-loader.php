...
if ( ! class_exists( 'UAEL_Loader' ) ) {
	...
	final class UAEL_Loader {
		...
		public function load_plugin() {
			...
			// Loaded on admin, REST, and frontend (Angie runs in Elementor editor).
			if ( function_exists( 'wp_register_ability' ) ) {
				require_once UAEL_DIR . 'abilities/class-uael-abilities.php';
			}
		...
		public function activation_reset() {
			...
			// plugin_activated is tracked on a deferred admin load (see UAEL_Analytics::detect_state_events),
			// not here, so the install source written by Starter Templates after activation is captured correctly.
