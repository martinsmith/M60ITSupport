...
if ( ! class_exists( 'Brainstorm_Update_UAEL' ) ) :
	...
	class Brainstorm_Update_UAEL {
		...
		public function __construct() {
			...
			// Suppress the generic BSF activation warning — replaced by the branded UAEL_License_Notice.
			add_filter( 'bsf_display_product_activation_notice_uael', '__return_false' );
