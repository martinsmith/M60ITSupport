...
// Abilities write theme settings directly, so customize_save_after never fires for them.
add_action( 'astra_ability_settings_updated', 'astra_addon_clear_cache_assets', 10 );
