		...
		public function get_mega_menu_option( $data ) {
			...
			$_config = array(
				...
				array(
					...
					'title'           => __( 'Mega Menu', 'astra-addon' ),
					// translators: %s is a link to the mega menu documentation.
					'description'     => sprintf(
						/* translators: %s: Learn more documentation link. */
						__( 'Turn a standard dropdown into a full-width, fully designed mega menu. %s', 'astra-addon' ),
						'<a href="' . astra_get_pro_url( '/docs-category/astra-pro-modules/pro-features/nav-menu/', 'astra-pro', 'nav-menu' ) . '" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Learn how', 'astra-addon' ) . '</a>'
					),
					'tab_type'        => 'general',
					'as_heading'      => true,
					'depth'           => 0,
				...
				array(
					...
					'control'         => 'ast-select',
					'title'           => __( 'Content Source', 'astra-addon' ),
					'description'     => __( '<strong>Custom Text:</strong> add your own text or HTML.<br><strong>Template / Custom Layout:</strong> display a saved Custom Layout.<br><strong>Widget:</strong> show widgets in the dropdown.', 'astra-addon' ),
					'divider'         => '',
					'choices'         => array(
						'default'     => __( 'Default', 'astra-addon' ),
						'custom_text' => __( 'Custom Text', 'astra-addon' ),
						'template'    => __( 'Template / Custom Layout', 'astra-addon' ),
				...
				array(
					...
					'title'          => __( 'Template / Custom Layout', 'astra-addon' ),
					'tab_type'       => 'general',
					'depth'          => 1,
					'context'        => array(
						array(
