...
function ArticleMarkup(url, value) {
    ...
    const request = new XMLHttpRequest();
        ...
        request.onload = function() {
            ...
            // Custom templates (e.g. Site Builder layouts) replace the default blog
            // markup entirely, so there is nothing to swap in — load the page fully.
            if ( ! data.querySelector( '#main > .ast-row' ) ) {
